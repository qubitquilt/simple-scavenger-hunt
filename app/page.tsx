    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <header className="text-center mb-12">
          <h1 className="text-5xl font-bold text-gray-900 mb-4">Simple Scavenger Hunt</h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            A fun and engaging scavenger hunt application designed to test your skills and creativity.
          </p>
        </header>
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600">Sign up to participate in the scavenger hunt.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-medium mb-3">2. Scan QR Codes</h3>
              <p className="text-gray-600">Find and scan QR codes at various locations.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-medium mb-3">3. Visit Event URLs</h3>
              <p className="text-gray-600">Access event-specific pages via provided URLs.</p>
            </div>
          </div>
        </section>

        <section className="mb-12">
          <h2 className="text-3xl font-semibold text-gray-900 mb-6">Instructions for Participants</h2>
          <ul className="list-disc list-inside text-gray-700 space-y-2 max-w-2xl mx-auto">
            ...
            <li>Visit the URLs provided for each event to access challenges.</li>
