...
export default function ImageQuestion({
      ...
      >
        <div className="bg-base-50 p-6 rounded-lg max-w-md w-full mx-4">
          ...
          <div className="flex space-x-3 mt-4">
            ...
            <button
              onClick={closeCamera}
              className="btn btn-secondary btn-block flex-1"
              tabIndex={0}
  ...
  return (
    <div className="space-y-4">
      ...
      {error && (
        <div
          className="p-3 bg-red-100 text-red-600 rounded-md"
          role="alert"
          aria-live="polite"
        >
          {error}
      ...
      {previewUrl ? (
        ...
        >
          ...
          <p className="text-xs text-gray-400">Supports all image formats</p>
        </div>
      )}
          ...
          <div className="modal-box w-11/12 max-w-sm sm:max-w-md md:max-w-lg">
            ...
            <div className="modal-action flex-col sm:flex-row gap-2 sm:gap-3">
              <button
                ...
                onKeyDown={(e) =>
                  handleKeyDown(e, () => setShowPreviewModal(false))
                }
              >
                Cancel
              </button>
